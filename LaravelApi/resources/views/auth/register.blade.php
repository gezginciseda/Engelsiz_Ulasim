            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="tc" class="col-md-4 col-form-label text-md-end">{{ __('Tc Kimlik No') }}</label>

                            <div class="col-md-6">
                                <input id="tc" type="integer" class="form-control @error('tc') is-invalid @enderror" name="tc" value="{{ old('tc') }}" required autocomplete="tc" autofocus>
